...
void RenderScene()
{
	...
	// Poszczególne ustawienia dla ka¿dego z obiektów:

    // Najpierw tworzymy model,
	// nastêpnie umieszczamy go (translate)
	// mo¿na go obróciæ (rotate)
	// i powiêkszyæ zmniejszyæ (scale)
	...
	//  W kó³ko zmieniamy obrót helikoptera
...
int main()
{
	mainWindow = Window(1920, 1024); // Rozdzielczoœæ ekranu
	...
	// Tworzenie materia³ów  ( intensywnoœæ œwiat³a, jasnoœæ , od 1 do 256 zazwyczaj)
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// Mo¿na w³¹czyæ/wy³¹czyæ latarkê za pomoc¹ L
